                    ...
                    <div className="flex gap-3">
                        {user ? (
                            <div className="relative">
                                ...
                                {showDropdown && (
                                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-[#1a2332] border border-slate-200 dark:border-[#232f48] rounded-lg shadow-lg py-1 z-50">
                                        <button onClick={handleLogout} className="block w-full text-left px-4 py-2 text-sm text-slate-900 dark:text-white hover:bg-slate-100 dark:hover:bg-[#232f48]">
                                            Đăng xuất
                                        </button>
                                    </div>
                                )}
