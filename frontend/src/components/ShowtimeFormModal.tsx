...
const ShowtimeFormModal: React.FC<Props> = ({
  open,
  initial,
  onClose,
  onSave,
      ...
      <div className="relative w-full max-w-xl bg-white dark:bg-surface-dark rounded-xl border border-slate-200 dark:border-border-dark p-6 shadow-lg">
        <div className="p-2 flex items-center justify-between mb-2">
          <h3 className="text-lg font-semibold text-slate-900 dark:text-white">
            {initial ? "Sửa suất chiếu" : "Thêm suất chiếu"}
          </h3>
          <button
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label className="flex flex-col">
              <span className="text-sm text-slate-700 dark:text-slate-300 mb-2">
                Phim
              </span>
              <Select
                value={movieId}
            ...
            <label className="flex flex-col">
              ...
              <DatePicker
                ...
                onChange={(dateVal) =>
                  setDate(dateVal ? dateVal.format("YYYY-MM-DD") : "")
                }
                format="DD/MM/YYYY"
            ...
            <label className="flex flex-col">
              ...
              <TimePicker
                ...
                onChange={(time) =>
                  setStartTime(time ? time.format("HH:mm") : "")
                }
                format="HH:mm"
                style={{ height: "44px", width: "100%" }}
              />
            ...
            <label className="flex flex-col">
              ...
              <TimePicker
                ...
                onChange={(time) =>
                  setEndTime(time ? time.format("HH:mm") : "")
                }
                format="HH:mm"
                style={{ height: "44px", width: "100%" }}
              />
            ...
            <div className="flex flex-col">
              ...
              <InputNumber
                ...
                onChange={(val) => setPrice(val?.toString() || "0")}
                min={0}
                step={1000}
                style={{ height: "44px", width: "100%" }}
              />
