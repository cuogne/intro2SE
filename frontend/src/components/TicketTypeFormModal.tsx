      ...
      <div className="bg-white dark:bg-surface-dark border border-slate-200 dark:border-white/10 w-full max-w-md rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-200 dark:border-white/10 flex items-center justify-between bg-white/5">
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">
            {initial ? "Chỉnh sửa loại vé" : "Thêm loại vé"}
          </h3>
          <button
            className="text-slate-400 hover:text-red-600 rounded-lg p-1 hover:bg-red-100 transition-colors"
            onClick={onClose}
          >
        ...
        <form onSubmit={submit} className="p-6 space-y-4">
              ...
              <div className="mb-2">
                <label className="border border-slate-200 rounded-lg dark:border-border-dark bg-slate-50 dark:bg-background-dark text-slate-900 dark:text-white px-4 py-2.5">
                  <input
                    ...
                    className="rounded"
                  />
                  <span className="w-full form-input rounded-lg ml-2">
                    Hoạt động
                  </span>
                </label>
              </div>
          ...
          <div className="flex items-center justify-end gap-3">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2 rounded-lg text-sm font-medium text-slate-300 hover:text-slate-600 hover:bg-gray-100"
            >
              Hủy
            </button>
            <button
              type="submit"
              className="px-4 py-2 rounded-lg text-sm font-medium bg-primary text-white hover:bg-blue-800"
            >
              Lưu
            </button>
          </div>
