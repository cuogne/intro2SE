...
const HomePage: React.FC = () => {
  ...
  const displayMovies =
    activeTab === "now"
      ? nowShowingMovies.slice(0, 5)
      : comingSoonMovies.slice(0, 5);
    ...
    <div className="flex-grow flex flex-col items-center">
            ...
            <div className="z-10 flex flex-col gap-4 max-w-2xl animate-fade-in-up">
              <div className="flex items-center gap-2 mb-2">
                <span className="bg-primary/90 text-white text-xs font-bold px-2 py-1 rounded">
                  {getAgeRating(heroMovie)}
                </span>
                <span className="bg-white/20 backdrop-blur-sm text-white text-xs font-bold px-2 py-1 rounded">
                  IMAX 3D
                </span>
              ...
              <p className="text-gray-200 text-base md:text-lg font-normal line-clamp-2 max-w-xl drop-shadow-md">
                {heroMovie.description ||
                  "Một kiệt tác điện ảnh không thể bỏ lỡ."}
              </p>
      ...
      <div className="w-full max-w-[1440px] px-4 md:px-10 mt-4">
        <div className="border-b border-gray-300 dark:border-[#232f48] flex gap-8 mb-8">
          ...
          >
            <p
              className={`text-lg font-bold transition-colors text-black ${
                activeTab === "now" ? "text-gray-900" : "text-gray-600"
          ...
          >
            <p
              className={`text-lg font-medium transition-colors text-black ${
                activeTab === "soon" ? "text-gray-900" : "text-gray-600"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-6 gap-y-10">
          {displayMovies.map((movie) => (
            <div key={movie._id} className="group flex flex-col gap-3">
              ...
              <div>
                <h3 className="text-gray-900 text-base font-bold leading-tight truncate group-hover:text-primary transition-colors">
                  {movie.title}
                </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative overflow-hidden rounded-xl bg-white dark:bg-[#232f48] border border-gray-200 dark:border-[#324467] group cursor-pointer h-48">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(90deg, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.2) 100%), url(https://images.unsplash.com/photo-1574267432553-4b4628081c31?w=800)",
                }}
              ></div>
              <div className="absolute inset-0 p-6 flex flex-col justify-center items-start">
                <span className="bg-primary text-white text-[10px] font-bold px-2 py-1 rounded mb-2">
                  HOT
                </span>
            ...
            <div className="relative overflow-hidden rounded-xl bg-white dark:bg-[#232f48] border border-gray-200 dark:border-[#324467] group cursor-pointer h-48">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(90deg, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.2) 100%), url(https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=800)",
                }}
              ></div>
              <div className="absolute inset-0 p-6 flex flex-col justify-center items-start">
                <span className="bg-red-500 text-white text-[10px] font-bold px-2 py-1 rounded mb-2">
                  MEMBER
                </span>
                <h3 className="text-white text-xl font-bold mb-1">
                  Thứ 3 Vui Vẻ
            ...
            <div className="relative overflow-hidden rounded-xl bg-white dark:bg-[#232f48] border border-gray-200 dark:border-[#324467] group cursor-pointer h-48 hidden lg:block">
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(90deg, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.2) 100%), url(https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=800)",
                }}
              ></div>
              <div className="absolute inset-0 p-6 flex flex-col justify-center items-start">
                <span className="bg-green-500 text-white text-[10px] font-bold px-2 py-1 rounded mb-2">
                  U22
                </span>
                <h3 className="text-white text-xl font-bold mb-1">
                  Ưu Đãi Học Sinh
