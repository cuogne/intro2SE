...
const SeatSelectionPage: React.FC = () => {
    ...
    try {
      if (isSelected) {
        ...
        if (bookingId) {
          ...
          const expiresIn =
            new Date(result.holdExpiresAt).getTime() - Date.now();
  ...
  const getSeatStatus = (row: string, number: number) => {
    ...
    if (selectedSeats.some((s) => s.row === row && s.number === number))
      return "selected";
    return "available";
  };
        ...
        <div className="lg:col-span-2">
          <div className="bg-white dark:bg-[#1a2332] border border-gray-200 dark:border-[#324467] rounded-xl p-6">
            ...
            <div className="mb-8 text-center">
              <div className="inline-block bg-gradient-to-r from-gray-600 to-gray-800 text-white px-8 py-2 rounded-t-lg">
                MÀN HÌNH
              </div>
            </div>
              ...
              {Object.keys(groupedSeats)
                ...
                .map((row) => (
                  <div key={row} className="flex items-center gap-2">
                    <div className="w-8 text-center text-gray-900 dark:text-white font-bold">
                      {row}
                    </div>
                        ...
                        .map((seat) => {
                          ...
                          return (
                            <button
                              ...
                              onClick={() =>
                                handleSeatClick(seat.row, seat.number)
                              }
