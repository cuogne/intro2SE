...
const MOCK_CINEMAS: Cinema[] = [
    {
        ...
        seatLayout: [
            ...
            { _id: "6944be92946fe3fc1e3fab0b", row: "C", seats: ["C1", "C2", "C3", "C4", "C5"] },
            { _id: "6944be92946fe3fc1e3fab0c", row: "D", seats: ["D1", "D2", "D3", "D4", "D5"] },
            { _id: "6944be92946fe3fc1e3fab0d", row: "E", seats: ["E1", "E2", "E3", "E4", "E5"] },
        ],
    },
    {
        ...
        seatLayout: [
            ...
            { _id: "6944be99946fe3fc1e3fab13", row: "C", seats: ["C1", "C2", "C3", "C4", "C5", "C6"] },
            { _id: "6944be99946fe3fc1e3fab14", row: "D", seats: ["D1", "D2", "D3", "D4", "D5", "D6"] },
            { _id: "6944be99946fe3fc1e3fab15", row: "E", seats: ["E1", "E2", "E3", "E4", "E5", "E6"] },
        ],
    },
];
...
export const createCinema = async (payload: Partial<Cinema>): Promise<Cinema | null> => {
    try {
...
export const updateCinema = async (id: string, payload: Partial<Cinema>): Promise<Cinema | null> => {
    try {
